...
set output '| ps2pdf -dEPSCrop - '.OUTPUT_FILE.'.pdf'


set title TITLE

set xlabel "Number of cores"
set ylabel "Speedup - 1"
...
plot for [COL=2:TOTAL_COL:12] INPUT_FILE using (1/column(COL)-1):xticlabels(1) t columnhead(COL) ls COL-1, 0 with lines lc 0
#plot for [COL=2:TOTAL_COL:12] INPUT_FILE using (1/column(COL)-1):COL+1:xticlabels(1) t columnhead(COL) ls COL-1, 0 with lines lc 0
#plot for [COL=2:TOTAL_COL:12] INPUT_FILE using COL:COL+1:xticlabels(1) t columnhead(COL) ls COL-1, 0 with lines lc 0
